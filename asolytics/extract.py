...
class Extract_keywords:
    ...
    def get_links(self, browser: webdriver.Firefox, bundleId) -> List[str]:
        ...
        try:
            ...
            button = self.__find_element_by_attribute_value(elements, "aria-label",
            ...
            if (button != None):
                ...
                for el in elements:
                    ...
                    if (not links.__contains__(href)) and (
                            href != None and href.startswith("https://play.google.com/store/apps/details?id=")):
                        links.append(href)
                # for e in links:
                #     print(e)
    ...
    def __find_element_by_attribute_value(self, elements: List[WebElement], attribute_name: str,
